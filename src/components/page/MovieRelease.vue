  ...
  <div v-loading="loading">
    ...
    <div class="container">
      ...
      <el-form ref="form" :model="form" label-width="140px" style="margin-top: 20px; margin-right: 20px">
        ...
        <el-row v-if="currentDirPath !== ''">
          <el-col :span="16">
            <el-form-item label="文件夹" prop="detail" label-width="140px">
              <el-input disabled type="string" v-model="currentDirPath"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="目录文件数" prop="detail" label-width="50%">
              <el-input disabled type="number" v-model="currentFileNum"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="8">
            ...
            <el-button type="primary" @click="renameFile()">重命名文件</el-button>
        ...
        <el-form-item label="主标题" prop="detail">
          <el-row>
            <el-col :span="23">
              <el-input type="textarea" :rows="1" v-model="form.main_title_movie">
              </el-input>
            </el-col>
            <el-col :span="1">
              <el-button icon="el-icon-refresh" @click="getNameFromTemplate('main_title_movie')"></el-button>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-form-item label="副标题" prop="detail">
          <el-row>
            <el-col :span="23">
              <el-input type="textarea" :rows="1" v-model="form.second_title_movie"></el-input>
            </el-col>
            <el-col :span="1">
              <el-button icon="el-icon-refresh" @click="getNameFromTemplate('second_title_movie')"></el-button>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-form-item label="文件名" prop="detail">
          <el-row>
            <el-col :span="23">
              <el-input type="textarea" :rows="1" v-model="form.file_name_movie"></el-input>
            </el-col>
            <el-col :span="1">
              <el-button icon="el-icon-refresh" @click="getNameFromTemplate('file_name_movie')"></el-button>
            </el-col>
          </el-row>
        </el-form-item>
...
export default {
  ...
  methods: {
      ...
      http.get(url)
          .then((response) => {
            ...
            if (data.statusCode === "OK") {
              console.log(data)
              if (template === "file_name_movie") {
                _self.form.file_name_movie = data.data.name
              } else if (template === "main_title_movie") {
                _self.form.main_title_movie = data.data.name
              } else if (template === "second_title_movie") {
                _self.form.second_title_movie = data.data.name
              }
            } else {
              _self.$message({
    ...
    selectFileName(index, row) {
      ...
      this.currentFileNum = this.fileList.length
    ...
    getPtGenInfo() {
      ...
      this.form.year = "";
      this.form.file_name_movie = "";
      this.form.main_title_movie = "";
      this.form.second_title_movie = "";
      ...
      http.get(url)
          .then((response) => {
            ...
            if (data.statusCode === "OK") {
              ...
              _self.getNameFromTemplate("main_title_movie");
              _self.getNameFromTemplate("second_title_movie");
              _self.getNameFromTemplate("file_name_movie");
    ...
    renameFolder() {
      ...
      const path = require('path');
      const params = {
        currentDir: this.currentDirPath,
        newFileName: this.form.file_name_movie
      };
      const url = '/api/renameFolder?' + new URLSearchParams(params).toString();
      let _self = this;
      http.post(url)
          .then((response) => {
            let data = response.data;
            if (data.statusCode === "OK") {
              _self.currentDirPath = data.data.newFilePath
              _self.form.filePath = path.join(_self.currentDirPath, _self.currentFileName)
              _self.$message({
                message: data.message,
                type: 'success'
              });
    ...
    renameFile() {
      ...
      http.post(url)
          .then((response) => {
            let data = response.data;
            if (data.statusCode === "OK") {
              _self.form.filePath = data.data.newFilePath
              _self.currentFileName = _self.form.filePath.replace(_self.currentDirPath + "/", "")
              _self.$message({
                message: data.message,
                type: 'success'
              });
